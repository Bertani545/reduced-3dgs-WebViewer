(function() {
    ...
    function n(t) {
        const a = {};
        return t.integrity && (a.integrity = t.integrity),
...
class X {
    ...
    add(e) {
        return typeof e == "number" ? new X(this.x + e,this.y + e,this.z + e) : new X(this.x + e.x,this.y + e.y,this.z + e.z)
    }
    subtract(e) {
        return typeof e == "number" ? new X(this.x - e,this.y - e,this.z - e) : new X(this.x - e.x,this.y - e.y,this.z - e.z)
    }
    ...
    lerp(e, n) {
        return new X(this.x + (e.x - this.x) * n,this.y + (e.y - this.y) * n,this.z + (e.z - this.z) * n)
    }
    length() {
...
class I {
    ...
    multiply(e) {
        const n = this.w
          ...
          , F = e.y
          , s = e.z;
        return new I(n * U + l * d + t * s - a * F,n * F - l * s + t * d + a * U,n * s + l * F - t * U + a * d,n * d - l * U - t * F - a * s)
    }
    flat() {
    ...
    static FromEuler(e) {
        const n = e.x / 2
          ...
          , s = Math.cos(t)
          , o = Math.sin(t);
        return new I(a * F * s + d * U * o,d * U * s - a * F * o,a * U * o - d * F * s,a * U * s + d * F * o)
    }
    toEuler() {
        const e = 2 * (this.w * this.x + this.y * this.z)
...
class xt {
    constructor() {
        ...
        ,
        this.hasEventListener = (n,l)=>!!e.has(n) && e.get(n).has(l),
...
class Dt extends xt {
    constructor() {
        super(),
        this._position = new X,
        this._rotation = new I,
        this._changeEvent = {
            type: "change"
        }
    }
    ...
    set position(e) {
        this._position.equals(e) || (this._position = e,
    ...
    set rotation(e) {
        this._rotation.equals(e) || (this._rotation = e,
        this.dispatchEvent(this._changeEvent))
    }
}
class Y {
    ...
    multiply(e) {
        const n = this.buffer
          , l = e.buffer;
        return new Y(l[0] * n[0] + l[3] * n[1] + l[6] * n[2],l[1] * n[0] + l[4] * n[1] + l[7] * n[2],l[2] * n[0] + l[5] * n[1] + l[8] * n[2],l[0] * n[3] + l[3] * n[4] + l[6] * n[5],l[1] * n[3] + l[4] * n[4] + l[7] * n[5],l[2] * n[3] + l[5] * n[4] + l[8] * n[5],l[0] * n[6] + l[3] * n[7] + l[6] * n[8],l[1] * n[6] + l[4] * n[7] + l[7] * n[8],l[2] * n[6] + l[5] * n[7] + l[8] * n[8])
    }
    clone() {
        const e = this.buffer;
        return new Y(e[0],e[1],e[2],e[3],e[4],e[5],e[6],e[7],e[8])
    }
    static Eye(e=1) {
        return new Y(e,0,0,0,e,0,0,0,e)
    }
    static Diagonal(e) {
        return new Y(e.x,0,0,0,e.y,0,0,0,e.z)
    }
    static RotationFromQuaternion(e) {
        return new Y(1 - 2 * e.y * e.y - 2 * e.z * e.z,2 * e.x * e.y - 2 * e.z * e.w,2 * e.x * e.z + 2 * e.y * e.w,2 * e.x * e.y + 2 * e.z * e.w,1 - 2 * e.x * e.x - 2 * e.z * e.z,2 * e.y * e.z - 2 * e.x * e.w,2 * e.x * e.z - 2 * e.y * e.w,2 * e.y * e.z + 2 * e.x * e.w,1 - 2 * e.x * e.x - 2 * e.y * e.y)
    }
    static RotationFromEuler(e) {
        const n = Math.cos(e.x)
          ...
          , d = Math.cos(e.z)
          , U = Math.sin(e.z);
        return new Y(t * d + a * l * U,-t * U + a * l * d,a * n,n * U,n * d,-l,-a * d + t * l * U,a * U + t * l * d,t * n)
    }
}
class $ {
    ...
    multiply(e) {
        const n = this.buffer
          , l = e.buffer;
        return new $(l[0] * n[0] + l[1] * n[4] + l[2] * n[8] + l[3] * n[12],l[0] * n[1] + l[1] * n[5] + l[2] * n[9] + l[3] * n[13],l[0] * n[2] + l[1] * n[6] + l[2] * n[10] + l[3] * n[14],l[0] * n[3] + l[1] * n[7] + l[2] * n[11] + l[3] * n[15],l[4] * n[0] + l[5] * n[4] + l[6] * n[8] + l[7] * n[12],l[4] * n[1] + l[5] * n[5] + l[6] * n[9] + l[7] * n[13],l[4] * n[2] + l[5] * n[6] + l[6] * n[10] + l[7] * n[14],l[4] * n[3] + l[5] * n[7] + l[6] * n[11] + l[7] * n[15],l[8] * n[0] + l[9] * n[4] + l[10] * n[8] + l[11] * n[12],l[8] * n[1] + l[9] * n[5] + l[10] * n[9] + l[11] * n[13],l[8] * n[2] + l[9] * n[6] + l[10] * n[10] + l[11] * n[14],l[8] * n[3] + l[9] * n[7] + l[10] * n[11] + l[11] * n[15],l[12] * n[0] + l[13] * n[4] + l[14] * n[8] + l[15] * n[12],l[12] * n[1] + l[13] * n[5] + l[14] * n[9] + l[15] * n[13],l[12] * n[2] + l[13] * n[6] + l[14] * n[10] + l[15] * n[14],l[12] * n[3] + l[13] * n[7] + l[14] * n[11] + l[15] * n[15])
    }
    clone() {
        const e = this.buffer;
        return new $(e[0],e[1],e[2],e[3],e[4],e[5],e[6],e[7],e[8],e[9],e[10],e[11],e[12],e[13],e[14],e[15])
    }
}
class Zt extends Dt {
    constructor(e=new X(0,0,0), n=new I, l=1132, t=1132, a=.01, d=1e3) {
        super();
        const U = ()=>{
            const F = Y.RotationFromQuaternion(this.rotation).buffer
              , s = this.position.flat()
              , o = [[F[0], F[1], F[2], 0], [F[3], F[4], F[5], 0], [F[6], F[7], F[8], 0], [-s[0] * F[0] - s[1] * F[3] - s[2] * F[6], -s[0] * F[1] - s[1] * F[4] - s[2] * F[7], -s[0] * F[2] - s[1] * F[5] - s[2] * F[8], 1]].flat()
              , i = [[F[0], F[3], F[6], s[0]], [F[1], F[4], F[7], s[1]], [F[2], F[5], F[8], s[2]], [0, 0, 0, 1]].flat();
            return this.viewToWorld = new $(...i),
            new $(...o)
        }
        ;
        this.position = e,
        ...
        this.viewMatrix = new $,
        this.viewProj = new $,
        this.viewToWorld = new $,
        this.update = (F,s)=>{
            this.projectionMatrix = new $(2 * this.fx / F,0,0,0,0,-2 * this.fy / s,0,0,0,0,this.far / (this.far - this.near),1,0,0,-this.far * this.near / (this.far - this.near),0),
            this.viewMatrix = U(),
    ...
    setFromData(e) {
        if (e.rotation.x != null)
            this.rotation = new I(e.rotation.x,e.rotation.y,e.rotation.z,e.rotation.w);
        else {
            let a = e.rotation.flat()
              , d = new Y(...a);
            this.rotation = I.FromMatrix3(d)
        }
        if (e.position.x != null)
            this.position = new X(e.position.x,e.position.y,e.position.z);
        else {
            let a = e.position;
            this.position = new X(...a)
        }
        ...
        this.fy = e.fy,
        new Zt;
        let n = Y.RotationFromEuler(new X(0,0,Math.PI / 2));
        console.log(n.buffer);
        let l = Y.RotationFromEuler(new X(Math.PI / 2,0,0));
        console.log(l.buffer);
        let t = Y.RotationFromEuler(new X(0,Math.PI / 2,0));
    ...
    static fromData(e) {
        let n = new X
          , l = new I;
        if (e.position.x != null)
            n = new X(e.position.x,e.position.y,e.position.z);
        else {
            let a = e.position;
            n = new X(...a)
        }
        if (e.rotation.x != null)
            l = new I(e.rotation.x,e.rotation.y,e.rotation.z,e.rotation.w);
        else {
            let a = e.rotation.flat()
              , d = new Y(...a);
            l = I.FromMatrix3(d)
...
class nt {
    static async LoadAsync(e, n, l, t="", a=!1, d=!1) {
    ...
    static async LoadFromFileAsync(e, n, l, t="", a=!1, d=!1) {
...
`).filter(J=>J.startsWith("property "))) {
        ...
        for (let c = 0; c < U; c++) {
            ...
            o.forEach(w=>{
                ...
                switch (w.type) {
                case "float":
                    G = i.getFloat32(w.offset + c * F, !0);
                    break;
                case "int":
                    G = i.getInt32(w.offset + c * F, !0);
                    break;
                default:
...
`).filter(V=>V.startsWith("property "))) {
    ...
    static _ParseFullPLYBufferFast(e, n, l) {
        ...
        for (let c = 0; c < e.vertexCount; c++) {
            ...
            J.set([t.getFloat32(U.x.offset + c * F, !0), t.getFloat32(U.y.offset + c * F, !0), t.getFloat32(U.z.offset + c * F, !0)], 0),
            u.set([Math.exp(t.getFloat32(U.scale_0.offset + c * F, !0)), Math.exp(t.getFloat32(U.scale_1.offset + c * F, !0)), Math.exp(t.getFloat32(U.scale_2.offset + c * F, !0))], 0),
            h.set([.5 + D * t.getFloat32(U.f_dc_0.offset + c * F, !0) * 255, .5 + D * t.getFloat32(U.f_dc_1.offset + c * F, !0) * 255, .5 + D * t.getFloat32(U.f_dc_2.offset + c * F, !0) * 255, 1 / (1 + Math.exp(-t.getFloat32(U.opacity.offset + c * F, !0))) * 255], 0),
            o = t.getFloat32(U.rot_0.offset + c * F, !0),
            i = t.getFloat32(U.rot_1.offset + c * F, !0),
            V = t.getFloat32(U.rot_2.offset + c * F, !0),
            r = t.getFloat32(U.rot_3.offset + c * F, !0),
            s = new I(i,V,r,o),
            s = s.normalize(),
            Q.set([128 * s.w + 128, 128 * s.x + 128, 128 * s.y + 128, 128 * s.z + 128], 0),
            R.set([t.getFloat32(U.f_dc_0.offset + c * F, !0), t.getFloat32(U.f_dc_1.offset + c * F, !0), t.getFloat32(U.f_dc_2.offset + c * F, !0)], 0),
            R.set([t.getFloat32(U.f_rest_0.offset + c * F, !0), t.getFloat32(U.f_rest_15.offset + c * F, !0), t.getFloat32(U.f_rest_30.offset + c * F, !0), t.getFloat32(U.f_rest_1.offset + c * F, !0), t.getFloat32(U.f_rest_16.offset + c * F, !0), t.getFloat32(U.f_rest_31.offset + c * F, !0), t.getFloat32(U.f_rest_2.offset + c * F, !0), t.getFloat32(U.f_rest_17.offset + c * F, !0), t.getFloat32(U.f_rest_32.offset + c * F, !0), t.getFloat32(U.f_rest_3.offset + c * F, !0), t.getFloat32(U.f_rest_18.offset + c * F, !0), t.getFloat32(U.f_rest_33.offset + c * F, !0), t.getFloat32(U.f_rest_4.offset + c * F, !0), t.getFloat32(U.f_rest_19.offset + c * F, !0), t.getFloat32(U.f_rest_34.offset + c * F, !0), t.getFloat32(U.f_rest_5.offset + c * F, !0), t.getFloat32(U.f_rest_20.offset + c * F, !0), t.getFloat32(U.f_rest_35.offset + c * F, !0), t.getFloat32(U.f_rest_6.offset + c * F, !0), t.getFloat32(U.f_rest_21.offset + c * F, !0), t.getFloat32(U.f_rest_36.offset + c * F, !0), t.getFloat32(U.f_rest_7.offset + c * F, !0), t.getFloat32(U.f_rest_22.offset + c * F, !0), t.getFloat32(U.f_rest_37.offset + c * F, !0), t.getFloat32(U.f_rest_8.offset + c * F, !0), t.getFloat32(U.f_rest_23.offset + c * F, !0), t.getFloat32(U.f_rest_38.offset + c * F, !0), t.getFloat32(U.f_rest_9.offset + c * F, !0), t.getFloat32(U.f_rest_24.offset + c * F, !0), t.getFloat32(U.f_rest_38.offset + c * F, !0), t.getFloat32(U.f_rest_10.offset + c * F, !0), t.getFloat32(U.f_rest_25.offset + c * F, !0), t.getFloat32(U.f_rest_40.offset + c * F, !0), t.getFloat32(U.f_rest_11.offset + c * F, !0), t.getFloat32(U.f_rest_26.offset + c * F, !0), t.getFloat32(U.f_rest_41.offset + c * F, !0), t.getFloat32(U.f_rest_12.offset + c * F, !0), t.getFloat32(U.f_rest_27.offset + c * F, !0), t.getFloat32(U.f_rest_42.offset + c * F, !0), t.getFloat32(U.f_rest_13.offset + c * F, !0), t.getFloat32(U.f_rest_28.offset + c * F, !0), t.getFloat32(U.f_rest_43.offset + c * F, !0), t.getFloat32(U.f_rest_14.offset + c * F, !0), t.getFloat32(U.f_rest_29.offset + c * F, !0), t.getFloat32(U.f_rest_44.offset + c * F, !0)], 3)
        }
        return [a, d]
    }
...
`).filter(Q=>Q.startsWith("property "))) {
        ...
        for (let h = 0; h < s; h++) {
            ...
            V.forEach(H=>{
                ...
                switch (H.type) {
                case "float":
                    B = r.getFloat32(H.offset + h * o, !0);
                    break;
                case "int":
                    B = r.getInt32(H.offset + h * o, !0);
                    break;
                default:
...
`).filter(x=>x.startsWith("property "))) {
        ...
        for (let m = 0; m < T; m++)
            for (let x = 0; x < 256; x++) {
                const S = E.getInt16(x * T * 2 + 2 * m, !0);
        ...
        for (let m = 0; m < 4; m++) {
            ...
            for (let y = 0; y < x; y++) {
                ...
                L.set([ht(new Int16Array([p.getInt16(N + S.x.offset + y * f, !0)]), 0, 1)[0], ht(new Int16Array([p.getInt16(N + S.y.offset + y * f, !0)]), 0, 1)[0], ht(new Int16Array([p.getInt16(N + S.z.offset + y * f, !0)]), 0, 1)[0]], 0),
                q = Q.scaling,
...
class qt {
    constructor(e=null, n=null) {
        ...
        const a = n || [];
        n || a.push(new Pt);
        let d, U, F, s, o, i, V, r, c, J, u, h, Q, R, W, T, E, p, w, G = !1, j = !1;
        this.resize = ()=>{
        ...
        this.setSize = (B,N)=>{
            ...
            t.uniformMatrix4fv(V, !1, U.projectionMatrix.buffer),
...
`),
            ...
            t.uniformMatrix4fv(J, !1, U.viewMatrix.buffer);
...
class $t {
    constructor(e, n, l=.5, t=.5, a=5, d=!0, U=new X) {
        this.minAngle = -90,
        this.maxAngle = 90,
        this.minZoom = .1,
        this.maxZoom = 30,
        ...
        const p = ()=>.1 + .9 * (V - this.minZoom) / (this.maxZoom - this.minZoom)
          , w = Z=>{
            T = !1,
            Q[Z.code] = !0,
            Z.code === "ArrowUp" && (Q.KeyW = !0),
            Z.code === "ArrowDown" && (Q.KeyS = !0),
            Z.code === "ArrowLeft" && (Q.KeyA = !0),
            Z.code === "ArrowRight" && (Q.KeyD = !0)
        }
          , G = Z=>{
            Q[Z.code] = !1,
            Z.code === "ArrowUp" && (Q.KeyW = !1),
            Z.code === "ArrowDown" && (Q.KeyS = !1),
            Z.code === "ArrowLeft" && (Q.KeyA = !1),
            Z.code === "ArrowRight" && (Q.KeyD = !1)
        }
          , j = Z=>{
            _(Z),
            r = !0,
...
let Rt = "Loading", bt = 0, Jt = !1, pt = !1, vt, Tt;
...
async function Ue(b) {
    ...
    const e = "";
    await nt.LoadFromFileAsync(b, rt, ut, e, Ht, !1).then(ft)
}
